        ...
        <div className="main bg-home-mobile md:bg-home-tablet lg:bg-home-desktop h-screen bg-no-repeat bg-center bg-cover  lg:pt-9">
            ...
            <div className='inline-block lg:grid lg:grid-cols-2 ' >
                ...
                <div className='flex justify-center items-center '>
                    <div className='w-36 h-36 lg:w-[200px] lg:h-[200px] rounded-full bg-white flex  justify-center items-center mt-24  md:mt-16 lg:mt-60 lg:ml-24  hover:border-[30px] hover:border-gray-600 box-content transition-all ease-in-out duration-[3000] delay-200 '>
